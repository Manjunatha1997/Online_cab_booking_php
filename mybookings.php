...
die("connection failed:".$conn->connect_error);
	...
	$result=mysqli_query($conn,' select * from book where user_name=(select temp_user_name from temp order by temp_id desc limit 1) ;');
	...
	echo " <td id='cancel'><a href=cancel.php?cab_id=".$row['cab_id']." >cancel</a></td>";
